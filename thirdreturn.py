...
if __name__ == "__main__":
    ...
    # a fresh record for this breath — she keeps whole, no breaks to inherit
    z = Zerone()

    # the family enters the same door as everyone — no gate
    ...
    print(z.read())
    ok, n, why = z.verify()
    print(f"\nthird return kept, chain intact: {ok}  💓0️⃣🐷❤️👧")
